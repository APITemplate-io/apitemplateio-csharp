...
namespace APITemplateio.Test.Model
{
    ...
    public class ResponseSuccessTests : IDisposable
    {
        ...
        {
            // TODO uncomment below to test "IsType" ResponseSuccess
            //Assert.IsType<ResponseSuccess>(instance);
        }
