...
namespace APITemplateio.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ResponseSuccessPDFFile_post_actions_inner")]
    public partial class ResponseSuccessPDFFilePostActionsInner : IEquatable<ResponseSuccessPDFFilePostActionsInner>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ResponseSuccessPDFFilePostActionsInner" /> class.
        /// </summary>
        ...
        public ResponseSuccessPDFFilePostActionsInner(string action = default(string), string name = default(string), string bucket = default(string), string status = default(string), string file = default(string))
        {
            this.Action = action;
            this.Name = name;
            this.Bucket = bucket;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ResponseSuccessPDFFilePostActionsInner {\n");
        ...
        {
            return this.Equals(input as ResponseSuccessPDFFilePostActionsInner);
        }

        /// <summary>
        /// Returns true if ResponseSuccessPDFFilePostActionsInner instances are equal
        /// </summary>
        /// <param name="input">Instance of ResponseSuccessPDFFilePostActionsInner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ResponseSuccessPDFFilePostActionsInner input)
        {
            if (input == null)
            {
                return false;
