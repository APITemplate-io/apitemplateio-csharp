...
namespace APITemplateio.Model
{
    ...
    /// </summary>
    [DataContract(Name = "create_pdf_from_url_request")]
    public partial class CreatePdfFromUrlRequest : IEquatable<CreatePdfFromUrlRequest>, IValidatableObject
    {
        /// <summary>
        ...
        public CreatePdfFromUrlRequest(string url = default(string), PDFGenerationSettingsObject settings = default(PDFGenerationSettingsObject))
        {
            this.Url = url;
        ...
        {
            return this.Equals(input as CreatePdfFromUrlRequest);
        }

        /// <summary>
        /// Returns true if CreatePdfFromUrlRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of CreatePdfFromUrlRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreatePdfFromUrlRequest input)
        {
            if (input == null)
            {
                return false;
