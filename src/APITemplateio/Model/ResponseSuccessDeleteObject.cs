...
namespace APITemplateio.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ResponseSuccessDeleteObject")]
    public partial class ResponseSuccessDeleteObject : IEquatable<ResponseSuccessDeleteObject>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ResponseSuccessDeleteObject" /> class.
        /// </summary>
        /// <param name="status">status.</param>
        /// <param name="transactionRef">transactionRef.</param>
        public ResponseSuccessDeleteObject(string status = default(string), Object transactionRef = default(Object))
        {
            this.Status = status;
        ...
        [DataMember(Name = "transaction_ref", EmitDefaultValue = true)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ResponseSuccessDeleteObject {\n");
        ...
        {
            return this.Equals(input as ResponseSuccessDeleteObject);
        }

        /// <summary>
        /// Returns true if ResponseSuccessDeleteObject instances are equal
        /// </summary>
        /// <param name="input">Instance of ResponseSuccessDeleteObject to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ResponseSuccessDeleteObject input)
        {
            if (input == null)
            {
                return false;
