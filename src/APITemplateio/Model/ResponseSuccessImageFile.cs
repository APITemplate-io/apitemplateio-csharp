...
namespace APITemplateio.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ResponseSuccessImageFile")]
    public partial class ResponseSuccessImageFile : IEquatable<ResponseSuccessImageFile>, IValidatableObject
    {
        /// <summary>
        ...
        /// <param name="downloadUrlPng">Download URL PNG.</param>
        /// <param name="templateId">Template ID.</param>
        /// <param name="transactionRef">Transaction reference.</param>
        /// <param name="postActions">postActions.</param>
        public ResponseSuccessImageFile(string status = default(string), string downloadUrl = default(string), string downloadUrlPng = default(string), string templateId = default(string), string transactionRef = default(string), List<ResponseSuccessPDFFilePostActionsInner> postActions = default(List<ResponseSuccessPDFFilePostActionsInner>))
        {
            this.Status = status;
        ...
        /// Download URL PNG
        /// </summary>
        /// <value>Download URL PNG</value>
        /// <example>https://bucket.s3.amazonaws.com/91f62769-69e4-48bf.png</example>
        [DataMember(Name = "download_url_png", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ResponseSuccessImageFile {\n");
            sb.Append("  Status: ").Append(Status).Append("\n");
            sb.Append("  DownloadUrl: ").Append(DownloadUrl).Append("\n");
            sb.Append("  DownloadUrlPng: ").Append(DownloadUrlPng).Append("\n");
        ...
        {
            return this.Equals(input as ResponseSuccessImageFile);
        }

        /// <summary>
        /// Returns true if ResponseSuccessImageFile instances are equal
        /// </summary>
        /// <param name="input">Instance of ResponseSuccessImageFile to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ResponseSuccessImageFile input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.DownloadUrlPng == input.DownloadUrlPng ||
                    (this.DownloadUrlPng != null &&
                    this.DownloadUrlPng.Equals(input.DownloadUrlPng))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.DownloadUrlPng != null)
                {
                    hashCode = (hashCode * 59) + this.DownloadUrlPng.GetHashCode();
                }
