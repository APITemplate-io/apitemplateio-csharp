...
namespace APITemplateio.Model
{
    ...
    public partial class Error : IEquatable<Error>, IValidatableObject
    {
        ...
        /// Initializes a new instance of the <see cref="Error" /> class.
        /// </summary>
        /// <param name="status">Value of the status: error (required).</param>
        /// <param name="message">Error message (required).</param>
        public Error(string status = default(string), string message = default(string))
        {
        ...
        /// </summary>
        /// <value>Value of the status: error</value>
