...
namespace APITemplateio.Model
{
    ...
    /// </summary>
    [DataContract(Name = "create_pdf_from_html_request")]
    public partial class CreatePdfFromHtmlRequest : IEquatable<CreatePdfFromHtmlRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreatePdfFromHtmlRequest" /> class.
        /// </summary>
        /// <param name="body">The HTML body content for the PDF. This property supports HTML markup and can include Jinja2 syntax (e.g {{name}}). The value of {{name}} will be replaced with the actual value provided in the data object. .</param>
        /// <param name="css">The CSS styles to be applied to the PDF. This property should contain valid CSS markup and should also include the style tag. .</param>
        /// <param name="data">The data object containing values for dynamic content in the HTML body. This object should include properties with corresponding values. .</param>
        /// <param name="settings">settings.</param>
        public CreatePdfFromHtmlRequest(string body = default(string), string css = default(string), Object data = default(Object), PDFGenerationSettingsObject settings = default(PDFGenerationSettingsObject))
        {
            this.Body = body;
            this.Css = css;
            this.Data = data;
        ...
        /// </summary>
        /// <value>The HTML body content for the PDF. This property supports HTML markup and can include Jinja2 syntax (e.g {{name}}). The value of {{name}} will be replaced with the actual value provided in the data object. </value>
        ...
        /// </summary>
        /// <value>The CSS styles to be applied to the PDF. This property should contain valid CSS markup and should also include the style tag. </value>
        /// <example>&quot;&lt;style&gt;.bg{backgound: red};&lt;/style&gt;&quot;
</example>
        ...
        /// </summary>
        /// <value>The data object containing values for dynamic content in the HTML body. This object should include properties with corresponding values. </value>
        ...
        public PDFGenerationSettingsObject Settings { get; set; }
        ...
        {
            return this.Equals(input as CreatePdfFromHtmlRequest);
        }

        /// <summary>
        /// Returns true if CreatePdfFromHtmlRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of CreatePdfFromHtmlRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreatePdfFromHtmlRequest input)
        {
            if (input == null)
            {
                return false;
