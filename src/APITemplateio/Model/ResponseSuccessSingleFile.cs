...
namespace APITemplateio.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ResponseSuccessSingleFile")]
    public partial class ResponseSuccessSingleFile : IEquatable<ResponseSuccessSingleFile>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ResponseSuccessSingleFile" /> class.
        /// </summary>
        /// <param name="status">Status.</param>
        /// <param name="primaryUrl">Generated PDF document.</param>
        /// <param name="totalPages">Page count.</param>
        /// <param name="transactionRef">Transaction reference.</param>
        public ResponseSuccessSingleFile(string status = default(string), string primaryUrl = default(string), int totalPages = default(int), string transactionRef = default(string))
        {
            this.Status = status;
        ...
        /// </summary>
        /// <value>Generated PDF document</value>
        /// <example>https://craftmypdf.com/output.pdf</example>
        [DataMember(Name = "primary_url", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  PrimaryUrl: ").Append(PrimaryUrl).Append("\n");
        ...
        {
            return this.Equals(input as ResponseSuccessSingleFile);
        }

        /// <summary>
        /// Returns true if ResponseSuccessSingleFile instances are equal
        /// </summary>
        /// <param name="input">Instance of ResponseSuccessSingleFile to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ResponseSuccessSingleFile input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.PrimaryUrl == input.PrimaryUrl ||
                    (this.PrimaryUrl != null &&
                    this.PrimaryUrl.Equals(input.PrimaryUrl))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                {
                    hashCode = (hashCode * 59) + this.PrimaryUrl.GetHashCode();
                }
